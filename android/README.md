...
[`android/release/stockea-1.4.0.apk`](./release/stockea-1.4.0.apk) · **v1.4.0** (`versionCode` 14). Firmado en release, sin el certificado de depuración que bloquea Play Protect. Desinstalá la versión anterior: la firma cambió.
