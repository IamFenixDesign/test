...
1. Descargá `ios/release/Stockea-1.2.0.ipa`. En Perfil tiene que decir Versión 1.2.0. Si iOS ya tenía Stockea 1.0.0, borrá los íconos viejos antes de instalar: con la misma versión no reemplaza la app.
