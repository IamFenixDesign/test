...
1. Descargá `ios/release/Stockea-1.5.0.ipa`. En Perfil tiene que decir Versión 1.5.0. Borrá la instalación anterior antes de instalar: si el número de versión no sube, iOS deja la app vieja.
